...
app_name="RedisFailoverManager"
factory_class_name="com.epam.tcodata.redis.manager.factory.impl.RedisFailoverManagerFactory"

/usr/hdp/${spark_ver}/spark2/bin/spark-submit \
--class com.epam.tcodata.redis.manager.RedisFailoverManager \
--name ${app_name} \
--master yarn \
--deploy-mode cluster \
`# SPARK CONFIGURATION` \
