...
public class OrganisationSubGroupDimensionRule implements ICustomRuleKind {

    /**
     * We need a default constructor.
     */
    public OrganisationSubGroupDimensionRule() {
        /***  Default implementation ***/
    }

    /**
     * It is quite naive implementation such method for OrganisationSubGroupDimension.
     *
    ...
    public Decision performDecision(IKeyManager keyManager, IDaoFactory daoFactory, EntityType entityType,
        ...
        Optional<KeyMapping> surrogateKey = mappingService.findByNaturalKey(EntityType.ORGANISATION_SUBGROUP, naturalKeyName, naturalKey);
