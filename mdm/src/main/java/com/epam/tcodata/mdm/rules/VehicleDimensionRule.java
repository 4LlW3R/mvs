...
public class VehicleDimensionRule implements ICustomRuleKind {
    /**
     * We need a default constructor.
     */
    public VehicleDimensionRule() {
    ...
    public Decision performDecision(IKeyManager keyManager, IDaoFactory daoFactory, EntityType entityType,
        ...
        Optional<KeyMapping> surrogateKey = mappingService.findByNaturalKey(EntityType.ASSET, naturalKeyName, naturalKey);
