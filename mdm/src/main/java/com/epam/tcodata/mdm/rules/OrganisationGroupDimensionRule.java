...
public class OrganisationGroupDimensionRule implements ICustomRuleKind {

    /**
     * We need a default constructor.
     */
    public OrganisationGroupDimensionRule() {
        /***  Default implementation ***/
    }

    /**
     * It is quite naive implementation such method for OrganisationGroupDimension.
    ...
    public Decision performDecision(IKeyManager keyManager, IDaoFactory daoFactory, EntityType entityType,
        ...
        Optional<KeyMapping>  surrogateKey = mappingService.findByNaturalKey(EntityType.ORGANISATION_GROUP, naturalKeyName, naturalKey);
