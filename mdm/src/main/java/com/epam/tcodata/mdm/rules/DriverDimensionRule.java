...
public class DriverDimensionRule implements ICustomRuleKind {

    /**
     * We need a default constructor.
     */
    public DriverDimensionRule() {
    ...
    public Decision performDecision(IKeyManager keyManager, IDaoFactory daoFactory, EntityType entityType,
        ...
        Optional<KeyMapping>  surrogateKey = mappingService.findByNaturalKey(EntityType.DRIVER, naturalKeyName, naturalKey);
