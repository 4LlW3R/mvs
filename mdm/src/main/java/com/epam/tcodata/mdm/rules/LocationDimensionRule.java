...
public class LocationDimensionRule implements ICustomRuleKind {

    /**
     * We need a default constructor.
     */
    public LocationDimensionRule() {
    ...
    public Decision performDecision(IKeyManager keyManager, IDaoFactory daoFactory, EntityType entityType,
        ...
        Optional<KeyMapping>  surrogateKey = mappingService.findByNaturalKey(EntityType.LOCATION, naturalKeyName, naturalKey);
