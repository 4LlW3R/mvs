...
public class MixMockExternalPumpBatchDriver {

    private static final Logger LOGGER = LoggerFactory.getLogger(MixMockExternalPumpBatchDriver.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (ClientAndServer mockServer = ClientAndServer.startClientAndServer(RestMockUtil.PORT)) {
            ...
            ExternalPumpBatchDriver.main(args);
        }
    }
