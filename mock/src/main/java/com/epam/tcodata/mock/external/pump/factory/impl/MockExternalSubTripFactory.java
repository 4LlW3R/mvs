...
public class MockExternalSubTripFactory extends MockAbstractExternalFactory<SubTrip, EnrichedSubTrip, AvroSubTrip> {

    private static final long serialVersionUID = -4028650950140616303L;

    public MockExternalSubTripFactory() {
        super(SubTrip.class);
    }

    @Override
    public IMixSource<SubTrip> createMixSource() {
    ...
    @Override
    public IConverter<SubTrip, EnrichedSubTrip, AvroSubTrip> createConverter() throws Exception {
