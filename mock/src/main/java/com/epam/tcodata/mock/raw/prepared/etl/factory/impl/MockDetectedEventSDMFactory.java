...
import com.epam.tcodata.raw.prepared.etl.factory.impl.DetectedEventSDMFactory;
import com.epam.tcodata.secure.storage.dal.ISecretStorage;
import com.epam.tcodata.secure.storage.dal.factory.ISecretStorageFactory;
import com.epam.tcodata.sql.dal.IDaoFactory;
import org.apache.spark.sql.SparkSession;

public class MockDetectedEventSDMFactory extends DetectedEventSDMFactory {

    private static final long serialVersionUID = 1043604588366285696L;

    @Override
    public IDaoFactory createPumpDaoFactory(ISecretStorage secretStorage) throws Exception {
        return new MockPumpsDaoFactory(secretStorage);
    }
