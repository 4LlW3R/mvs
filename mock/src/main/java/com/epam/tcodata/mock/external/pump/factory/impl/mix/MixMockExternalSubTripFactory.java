...
public class MixMockExternalSubTripFactory extends MixMockAbstractExternalFactory<SubTrip, EnrichedSubTrip, AvroSubTrip> {

    private static final long serialVersionUID = -4028650950140616303L;

    public MixMockExternalSubTripFactory() {
        super(SubTrip.class);
    }
