...
public class PreparedSubTrip extends PreparedEntity {

    private static final long serialVersionUID = 2474434318217739131L;
    ...
    public static class Fields {
        ...
        public static final String MAX_ACCELERATION_KILOMETERS_PER_HOUR_PER_SECONS = "max_acceleration_kilometers_per_hour_per_second";
        public static final String MAX_DECELERATION_KILOMETERS_PER_HOUR_PER_SECONS = "max_deceleration_kilometers_per_hour_per_second";
    ...
    @ColumnName(Fields.MAX_ACCELERATION_KILOMETERS_PER_HOUR_PER_SECONS)
    private Double maxAccelerationKilometersPerHourPerSecond;
    @ColumnName(Fields.MAX_DECELERATION_KILOMETERS_PER_HOUR_PER_SECONS)
