...
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Trip'
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_SubTrip'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Position'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Event'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Driver'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Asset'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_Location'
tblproperties ("skip.header.line.count"="1");
...
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
STORED AS TEXTFILE
location 'dbfs:/mnt/mvsdatalaket332testtco/sshadmin/external-pumps/dump/MixMockExternalPump_LibraryEvent'
tblproperties ("skip.header.line.count"="1");
