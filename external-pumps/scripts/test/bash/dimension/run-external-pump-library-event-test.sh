...
driver_name="ExternalPumpBatchDriver"
app_name="ExternalPump_LibraryEvent"
factoryClassName="com.epam.tcodata.external.pump.factory.impl.ExternalLibraryEventFactory"
dumpRdd="true"
